...
export class Template3Component implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.url = sessionStorage.getItem('urlYoutube') == null ? 'https://www.youtube.com/watch?v=4PCJQiLw7oE' : sessionStorage.getItem('urlYoutube');
  ...
  changeURL(url) {
    sessionStorage.setItem('urlYoutube', url);
    this.url = url;
    this.iframe_html = this.embedService.embed(this.url, {
      attr: { width: 800, height: 450 }
    });
