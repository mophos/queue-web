...
@Component({
  selector: 'app-queue-caller-department-group',
  templateUrl: './queue-caller-department-group.component.html',
  styleUrls: ['./queue-caller-department-group.component.css']
})
export class QueueCallerDepartmentGroupComponent implements OnInit {
